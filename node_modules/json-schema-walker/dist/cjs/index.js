...
class Walker {
    constructor() {
        this.loadSchema = (schema, options) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (dereference) {
                ...
                this.rootSchema = (yield parser.dereference(handleRootReference(schema), dereferenceOptions || {}));
            }
        });
        this.walk = (processor, vocabulary) => __awaiter(this, void 0, void 0, function* () {
            this.vocabulary = vocabulary !== null && vocabulary !== void 0 ? vocabulary : this.vocabularies.DRAFT_07;
            this.walker = processor;
            this.walker(this.rootSchema);
            yield this.subschemaWalk(this.rootSchema);
            ...
            return (schema, keyword) => {
                ...
                for (const ldo of schema.links) {
                    for (const key in ldo) {
                        try {
                            (_a = ldoVocabulary[keyword]) === null || _a === void 0 ? void 0 : _a.call(ldoVocabulary, schema, key);
                        }
                        catch (e) {
        ...
        this.initVocabulary = () => {
            ...
            const DRAFT_04_HYPER = Object.assign(Object.assign({}, DRAFT_04), { links: this.getProcessLinks(DRAFT_04_HYPER_LDO) });
            const DRAFT_06 = Object.assign(Object.assign({}, DRAFT_04), { propertyNames: this.processObjectOfSchemas });
            const DRAFT_06_HYPER_LDO = {
                hrefSchema: this.applyUserProcessor,
                targetSchema: this.applyUserProcessor,
                submissionSchema: this.applyUserProcessor,
            };
            const DRAFT_06_HYPER = Object.assign(Object.assign({}, DRAFT_06), { links: this.getProcessLinks(DRAFT_06_HYPER_LDO) });
            const DRAFT_07 = Object.assign({}, DRAFT_06);
            const DRAFT_07_HYPER_LDO = Object.assign(Object.assign({}, DRAFT_06_HYPER_LDO), { headerSchema: this.applyUserProcessor });
            const DRAFT_07_HYPER = Object.assign(Object.assign({}, DRAFT_07), { links: this.getProcessLinks(DRAFT_07_HYPER_LDO) });
            const CLOUDFLARE_DOCA = Object.assign(Object.assign({}, DRAFT_04), { links: this.getProcessLinks(Object.assign(Object.assign({}, DRAFT_04_HYPER_LDO), DRAFT_07_HYPER_LDO)) });
            this.vocabularies = {
                DRAFT_04,
                DRAFT_04_HYPER,
                DRAFT_04_HYPER_LDO,
