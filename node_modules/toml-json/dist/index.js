 ...
 * @param source
 */
const tomlJson = (source) => {
    let arr = [];
    if (source.fileUrl) {
        arr = fs.readFileSync(path_1.resolve('.', source.fileUrl)).toString().split('\n');
    }
    else if (source.data) {
 ...
 * @param sttrValue
 */
const setAttrValue = (obj, sttrKey, sttrValue) => {
