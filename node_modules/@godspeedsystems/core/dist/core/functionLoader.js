...
function loadFunctions(datasources, pathString) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let jsCode = yield (0, codeLoader_1.default)(pathString);
        let loadFnStatus;
        logger_1.logger.debug('JS functions %s', Object.keys(jsCode));
        logger_1.logger.debug('Yaml Workflows %s', Object.keys(functions));
        logger_1.logger.debug('Framework defined  functions %s', Object.keys(functions));
        logger_1.logger.debug('Datasource Functions %o', Object.keys(datasources));
        ...
        code = Object.assign(Object.assign(Object.assign({}, code), _datasourceFunctions), jsCode);
        ...
        loadFnStatus = { success: true, functions: Object.assign(Object.assign({}, functions), jsCode) };
        logger_1.logger.info('Loaded YAML workflows: %o', Object.keys(functions));
        logger_1.logger.info('Loaded JS workflows %o', Object.keys(jsCode));
        return loadFnStatus;
    });
}
