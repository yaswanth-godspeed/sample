...
var import_forbiddenPreviewFeatureWithProxyFlagMessage = require("./forbiddenPreviewFeatureWithProxyFlagMessage");
...
function checkForbiddenFeaturesWithDataProxyFlag(config, options) {
  options.dataProxy === true && config.generators.some((generatorConfig) => {
    return generatorConfig.previewFeatures.some((feature) => {
      if (feature.toLocaleLowerCase() === "metrics".toLocaleLowerCase()) {
        throw new Error((0, import_forbiddenPreviewFeatureWithProxyFlagMessage.forbiddenPreviewFeatureWithDataProxyFlagMessage)("metrics"));
      }
      if (feature.toLocaleLowerCase() === "tracing".toLocaleLowerCase()) {
        throw new Error((0, import_forbiddenPreviewFeatureWithProxyFlagMessage.forbiddenPreviewFeatureWithDataProxyFlagMessage)("tracing"));
      }
    });
  });
}
