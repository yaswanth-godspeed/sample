 ...
 */
export declare function getSSLVersion(args: GetOpenSSLVersionParams): Promise<GetOsResultLinux['libssl'] | undefined>;
/**
...
export type PlatformWithOSResult = GetOSResult & {
 ...
 */
export declare function getPlatformWithOSResult(): Promise<PlatformWithOSResult>;
export declare function getPlatformMemoized(): Promise<PlatformWithOSResult & {
    memoized: boolean;
}>;
/**
 * This function is only exported for testing purposes.
 */
export declare function getPlatformInternal(args: GetOSResult): Platform;
/**
 ...
 */
declare function getArchFromUname(): Promise<string | undefined>;
export {};
