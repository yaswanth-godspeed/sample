...
import type { BatchQueryEngineResult, EngineConfig, EngineEventType, EngineQuery, GetConfigResult, RequestBatchOptions, RequestOptions } from '../common/Engine';
...
export declare class BinaryEngine extends Engine<undefined> {
    ...
    requestBatch<T>(queries: EngineQuery[], { traceparent, transaction, numTry, containsWrite }: RequestBatchOptions<undefined>): Promise<BatchQueryEngineResult<T>[]>;
    /**
