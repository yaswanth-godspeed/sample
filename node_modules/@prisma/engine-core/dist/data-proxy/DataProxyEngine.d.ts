...
import type { BatchQueryEngineResult, EngineConfig, EngineEventType, EngineQuery, GetConfigResult, InteractiveTransactionOptions, RequestBatchOptions, RequestOptions } from '../common/Engine';
...
export declare class DataProxyEngine extends Engine<DataProxyTxInfoPayload> {
    ...
    requestBatch<T>(queries: EngineQuery[], { traceparent, transaction, customDataProxyFetch }: RequestBatchOptions<DataProxyTxInfoPayload>): Promise<BatchQueryEngineResult<T>[]>;
